...
// suggestions
// story 1
const prompt1 = "shooting star in sky at sunrise over city silhouette, digital illustration";
const url1 = "https://st4.depositphotos.com/1231957/19909/v/600/depositphotos_199093084-stock-video-natural-night-starry-sky-above.jpg";
// story 2
const prompt2 = "a detailed oil painting of a dark, mysterious forest, muted colors";
const url2 = "https://c4.wallpaperflare.com/wallpaper/960/465/206/fantasy-forest-landscape-sunbeam-stream-wallpaper-preview.jpg";

// text vars for story 2
const text2 = "The trail to the left had a \"Danger! Do Not Pass\" sign telling people to take the trail " +
    "to the right. This wasn't the way Zaya approached her hiking. Rather than a warning, Zaya read " +
    "the sign as an invitation to explore an area that would be adventurous and exciting. As the " +
    "others in the group all shifted to the right, Zaya slipped past the danger sign to begin an " +
    "adventure she would later regret."
